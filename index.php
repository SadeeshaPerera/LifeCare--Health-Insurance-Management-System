...
<!--Quote-->
  ...
  <section id="provider-section">
    <div class="container3">
      ...
      <div class="text3">
        <h2 id="providers"><center>HealthCare Providers</center></h2><br><br>
    ...
    <!-- <div class="icons">
      ...
      <!-- <img id="claim_img" src="images/Sadeeimages/packages.jpg"> -->
        <div class="help-section"  >
          ...
          <div id="textbox5"style="margin-right: -40px; margin-top:60px;"> 
            ...
            <a href="./PHP/ContactUs.php"><button id="claim_bttn" style="margin-left:500px;background-color:rgb(42, 155, 255);";>Contact Us</button></a>
          </div>
